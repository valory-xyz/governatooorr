...
HAPPY_PATH: Tuple[RoundChecks, ...] = (
    ...
    RoundChecks(SynchronizeDelegationsRound.auto_round_id(), n_periods=1),
    RoundChecks(VerifyDelegationsRound.auto_round_id(), n_periods=2),
    RoundChecks(CollectActiveProposalsRound.auto_round_id(), n_periods=2),
    RoundChecks(SelectProposalRound.auto_round_id(), n_periods=2),
    RoundChecks(EstablishVoteRound.auto_round_id(), n_periods=2),
    RoundChecks(PrepareVoteTransactionRound.auto_round_id(), n_periods=2),
    # TODO: add settlement rounds
)
