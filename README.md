...
4. Create the agent's key:
    ...
    ```
5. Create a `key::did` and a Ceramic stream using Ceramic's [JS client](https://developers.ceramic.network/docs/composedb/set-up-your-environment). The service will use this stream to store delegations.
