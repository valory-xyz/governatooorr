...
class SolanaResetRound(CollectSameUntilThresholdRound):
    ...
    def end_block(self) -> Optional[Tuple[BaseSynchronizedData, Event]]:
        ...
        if self.threshold_reached:
            ...
            # we have a failure. We could instead just remove the `SolanaResetRound` and transition to the
...
class SolanaTransactionSubmissionAbciApp(AbciApp[Event]):
    ...
    transition_function: AbciAppTransitionFunction = {
        ...
        CreateTxSelectKeeperRound: {
            ...
            Event.NO_MAJORITY: SolanaResetRound,
