...
class EstablishVoteBehaviour(ProposalVoterBaseBehaviour):
    ...
    def async_act(self) -> Generator:
        ...
        with self.context.benchmark_tool.measure(self.behaviour_id).local():
            ...
            token_adress = "0x323A76393544d5ecca80cd6ef2A560C6a395b7E3" # TODO: check this, erc 20 token address is required but not found
    ...
    def _get_service_vote_intention(self, token_address) -> str:
        ...
        # Count votes
        for delegation_data in self.synchronized_data.current_token_to_delegations.get(token_address, {}).values():
